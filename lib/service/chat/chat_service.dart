...
class ChatService{
  ...
  Future <void> sendMessage(String receiverID, message)async{
    ...
    //contruct chat room ID for the 2 users
    List<String> ids =  [currentUserID, receiverID];
    ids.sort(); // sort the ids ( this ensures that 2 people have the same chat room id)
  ...
  Stream<QuerySnapshot> getMessages(String userID, otherUserID){
    ...
    ids.sort(); // sort the ids ( this ensures that 2 people have same chat room id)
    String chatRoomID = ids.join('_');
